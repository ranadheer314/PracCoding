...
int main() {
	...
	if (found == true) {
		cout << "Repeated number is " << ones << endl;
		cout << "Missing number is " << zeros << endl;
	}
	else {
		cout << "Repeated number is " << zeros << endl;
		cout << "Missing number is " << ones << endl;
	}
